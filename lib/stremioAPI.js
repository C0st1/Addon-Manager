...
// Node 18+ (and Vercel's runtime) has native fetch — no node-fetch needed.
// If you're running locally on Node 14/16, run: npm install node-fetch@2
// and uncomment: const fetch = require('node-fetch');
